                        ...
                        <?php } else { ?>
                            ...
                            <div class="row mb-2  text-center text-md-start">
                                ...
                                <div class="col-md-8 text-center text-md-start d-flex justify-content-center justify-content-md-start">
                                    <?php if (isset($_POST["editProfileSubmit"])) : ?>
                                        <div class="col-8 ">
                                            <input type="text" id="inputName" name="profileUserName" class="form-control" value="<?php echo $user->getName(); ?>">
                                        </div>
                                        <?php
                                        echo '<script> document.getElementById("inputName").addEventListener("input", function (e) {
