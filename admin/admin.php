            ...
            <table class="table table-striped mt-3 bg-light custom-card-border-2">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a class="klk" href="../profile/profile.php?id=<?php echo $row['id']; ?>"><?php echo htmlspecialchars($row['nombre']); ?></a></td>
                        <td><?php echo htmlspecialchars($row['apodo']); ?></td>
                        <td><?php echo htmlspecialchars($row['correo']); ?></td>
                        <td>
                            <i class="bi bi-trash-fill delete-user" data-id="<?php echo $row['id']; ?>" style="cursor:pointer;"></i>
                            <i class="bi bi-lock-fill block-user" data-id="<?php echo $row['id']; ?>" style="cursor:pointer;"></i>
                        </td>
                    </tr>
                    <?php endwhile; ?>
                </tbody>
            ...
            <table class="table table-striped mt-3">
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination">
                        ...
                        <?php endif; ?>
                        <span class="pagination-item  d-inline-block p-2  align-middle">Página <?php echo $pageUsuarios; ?> de <?php echo $totalPagesComprados; ?></span>
                    </ul>
                </nav>
                <!-- Paginación Usuarios -->
            </table>
            ...
            <table class="table table-striped mt-3 bg-light custom-card-border-2">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a class="klk" href="../profile/profile.php?id=<?php echo $row['id_usu_vendedor']; ?>"><?php echo htmlspecialchars($row['apodo']); ?></a></td>
