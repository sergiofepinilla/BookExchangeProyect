...
<div class="container">
    <div class="col m-3 ">
        <!-- TABLA PRODUCTOS-->
        <table class="table table-bordered border-white dark-theme custom-text">
            <thead class=" accent">
                <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="../includes/deleteUser.inc.php?id=<?php echo $row[
                                    ...
                                    <i class="bi bi-trash btn btn-danger border custom-card-border-2"></i>
                                </a>
                            </td>
                        </tr>
                    <?php }
                                ...
                                <?php } else { ?>
                                    ...
                                    <td>
                                        ...
                                        <a href="admin.php?admin=products&pId=<?php echo $row[
                                            ...
                                            <i class="bi bi-pencil btn btn-success border custom-card-border-2"></i>
                                        </a>
