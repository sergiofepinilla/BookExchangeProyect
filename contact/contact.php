    ...
    <div class="row">
        <div class="col-12 col-lg-6 mb-3 mt-3">
            <form action="../includes/contact.inc.php" method="POST">
                ...
                <button type="submit" class="btn btn-primary btn-md mt-3" name="contact-submit">Enviar</button>
            </form>
        </div>
        <div class="col-12 col-lg-6 mb-3 mt-3">
            <div class="col-12 d-flex justify-content-center d-lg-block">
                <h2 class="title mt-2 text-center">Datos de contacto</h2>
            </div>
            <hr>
