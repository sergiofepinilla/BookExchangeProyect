                                    ...
                                    <div class="d-flex text-black">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            ...
                                            <div class="d-flex pt-1">
                                                ...
                                                <button type="button" class="btn btn-primary flex-grow-1">Ver Perfil</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<div class="container">
    <hr>
    <h1>Más productos del Vendedor</h1>
</div>
<?php echo "<script>const currentUserId = $userId;</script>"; ?>
